...
namespace Kenedia.Modules.ZoomOut
{
    public class Control_AddButton : Control
    {
        ...
        public Control_AddButton()
        {
            ...
            Add = ZoomOut.TextureManager.getControlTexture(_Controls.Add);
            AddHovered = ZoomOut.TextureManager.getControlTexture(_Controls.Add_Hovered);
            _EmptyTraitLine = ZoomOut.TextureManager.getControlTexture(_Controls.PlaceHolder_Traitline).GetRegion(0, 0, 647, 136);
            _Template_Border = ZoomOut.TextureManager.getControlTexture(_Controls.Template_Border);
    ...
    public class iTab : Panel
    {
        ...
        public iTab(Container parent)
        {
            ...
            Icon = ZoomOut.TextureManager.getIcon(_Icons.Bug);
            LeftBar = ZoomOut.TextureManager.getControlTexture(_Controls.TabBorderLeft);
            RightBar = ZoomOut.TextureManager.getControlTexture(_Controls.TabBorderRight);
    ...
    public class iMainWindow : StandardWindow
    {
        ...
        {
            get => ZoomOut.ModuleInstance.Selected_Template;
            set
            {
                if (value != null)
                {
        ...
        public iMainWindow(Texture2D background, Rectangle windowRegion, Rectangle contentRegion, TextureManager textureManager, Container parent, Template template) : base(background, windowRegion, contentRegion)
        {
            ...
            Parent = parent;
            _Template = template;
            ZoomOut.ModuleInstance.Selected_Template = template;
            _EmptyTraitLine = ZoomOut.TextureManager.getControlTexture(_Controls.PlaceHolder_Traitline).GetRegion(0, 0, 647, 136);
            ...
            _TabBarTexture = ZoomOut.TextureManager.getControlTexture(_Controls.TabBar_FadeIn);
            _TabBar_Line = ZoomOut.TextureManager.getControlTexture(_Controls.TabBar_Line);
            ...
            {
                Texture = ZoomOut.TextureManager.getIcon(_Icons.Bug),
            ...
            ResetButton = new Image()
            {
                ...
                Texture = ZoomOut.TextureManager.getControlTexture(_Controls.Delete),
            ...
            {
                ResetButton.Texture = ZoomOut.TextureManager.getControlTexture(_Controls.Delete_Hovered);
            };
            ResetButton.MouseLeft += delegate
            {
                ResetButton.Texture = ZoomOut.TextureManager.getControlTexture(_Controls.Delete);
            };
            ...
            SaveName = new Image()
            {
                Texture = ZoomOut.TextureManager.getIcon(_Icons.Checkmark_Color),
                Parent = this,
            ...
            {
                SaveName.Texture = ZoomOut.TextureManager.getIcon(_Icons.Checkmark_Highlight);

            };
            SaveName.MouseLeft += delegate
            {
                SaveName.Texture = ZoomOut.TextureManager.getIcon(_Icons.Checkmark_Color);

            };

            CancelName = new Image()
            {
                Texture = ZoomOut.TextureManager.getIcon(_Icons.Stop_Color),
                Parent = this,
            ...
            {
                CancelName.Texture = ZoomOut.TextureManager.getIcon(_Icons.Stop_Highlight);
            };
            CancelName.MouseLeft += delegate
            {
                CancelName.Texture = ZoomOut.TextureManager.getIcon(_Icons.Stop_Color);
            };
        ...
        {
            ZoomOut.ModuleInstance.Selected_Template = e.Template;
